...
valsCol = 6
destSheet = 'NDTC16a'
testTitle = "Ending Balances should be Increasing for All FrontBook Products" 
ignoreRate = 'Rate Discretion'
scenarioOnly = 0  #1 for Scenario only, 0 for Both Scenario and Baseline
thresh = 1
fbBook = ['platinumparkit', 'justinvest', 'retailsb', 'seniorsb', 'greensb', \
             'seniorgb', 'moneytrader', 'optimumplus', 'easyaccess', \
             'fixeddeposit']
#backBook = ['nedterm', 'parkit', 'money24']
